  ...
  return (
    <div>
      ...
      <div className="py-10 md:py-20 px-5 bg-pink-50">
        <div className="max-w-screen-lg mx-auto">
          <h2 className="text-center text-4xl font-bold">{t('explanation.title')}</h2>
          <p className="text-pink-600 font-bold text-center text-lg mt-4">{t('explanation.subTitle')}</p>
