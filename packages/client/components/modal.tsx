...
const Modal: FC<ModalProps> = ({ children, close, open }) => {
  ...
  return <div className={`fixed top-0 left-0 w-screen h-screen bg-gray-900 ${visible ? 'bg-opacity-50' : 'bg-opacity-0'} flex justify-center items-center`} onClick={close}>
